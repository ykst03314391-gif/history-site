...
> **前提：記事は2層でつくる。** まず `drafts/<id>.md` に**論文版オリジナル**（厳密・出典完備・論証つき）を書き、この Web 記事（`data/articles/<id>.md`）はそれを**噛み砕いた公開版**にする。詳細は [`../drafts/README.md`](../drafts/README.md)・README「記事は2層でつくる」。
